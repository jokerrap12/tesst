...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TESTTEAM/Files_TEST/master/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/jokerrap12/TESST/main/TESST.lua')
...
send(msg.chat_id_, msg.id_,'☆↯⇠  عدد الجروبات الان » { '..#group..' }'..TESTk..''..TEST..'\n☆↯⇠  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
os.execute('rm -rf TEST.lua')
os.execute('wget https://raw.githubusercontent.com/jokerrap12/TEST/main/TEST.lua')
send(msg.chat_id_, msg.id_,' ☆↯⇠ تم تحديث السورس \n ☆↯⇠ لديك اخر اصدار لسورس تيست\n ☆↯⇠ الاصدار » { 1.3v}')
dofile('TEST.lua')  
end
...
local TESTTEAM = '↯☆اهلا عزيزي ⇇ '..TESTRank(msg)..' \n↯☆تم تفعيل اوامر النسب'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TESTTEAM, 14, string.len(msg.sender_user_id_))
TEST:del(TEST..'TEST:Nsba:TEST'..msg.chat_id_) 
end
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TESTTEAM, 14, string.len(msg.sender_user_id_))
TEST:set(TEST..'TEST:Nsba:TEST'..msg.chat_id_,true)  
end
--     Source TEST     --
if not TEST:get(TEST..'TEST:Nsba:TEST'..msg.chat_id_) then
if text == "نسبه الحب" and SourceCh(msg) or text == "نسبة الحب" and SourceCh(msg) then
TEST:set(TEST..'LoveNsba:TEST'..msg.chat_id_..msg.sender_user_id_,true) 
TEST(msg.chat_id_, msg.id_, 1, '↯☆قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ⇇ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and TEST:get(TEST..'LoveNsba:TEST'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
TEST(msg.chat_id_, msg.id_, 1, '↯☆تم الغاء امر نسبة الحب ', 1, 'md')
TEST:del(TEST..'LoveNsba:TEST'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
TEST = math.random(0,100);
TEST(msg.chat_id_, msg.id_, 1, '↯☆نسبة الحب بين '..text..' هي : '..TEST..'%', 1, 'md')
TEST:del(TEST..'LoveNsba:TEST'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not TEST:get(TEST..'TEST:Nsba:TEST'..msg.chat_id_) then
if text and (text == "نسبه الرجوله" or text == "نسبة الرجوله" or text == "نسبه رجوله" or text == "نسبة رجوله") and SourceCh(msg) then
TEST:set(TEST..'RjolaNsba:TEST'..msg.chat_id_..msg.sender_user_id_,true) 
TEST(msg.chat_id_, msg.id_, 1, '↯☆قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ⇇ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and TEST:get(TEST..'RjolaNsba:TEST'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
TEST(msg.chat_id_, msg.id_, 1, '↯☆تم الغاء امر نسبة الرجوله ', 1, 'md')
TEST:del(TEST..'RjolaNsba:TEST'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
TEST = math.random(0,100);
TEST(msg.chat_id_, msg.id_, 1, '↯☆نسبة رجولة '..text..' هي : '..TEST..'%', 1, 'md')
TEST:del(TEST..'RjolaNsba:TEST'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not TEST:get(TEST..'TEST:Nsba:TEST'..msg.chat_id_) then
if text and (text == "نسبه الانوثه" or text == "نسبة الانوثه" or text == "نسبه انوثه" or text == "نسبة انوثه") and SourceCh(msg) then
TEST:set(TEST..'AnothaNsba:TEST'..msg.chat_id_..msg.sender_user_id_,true) 
TEST(msg.chat_id_, msg.id_, 1, '↯☆قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ⇇ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and TEST:get(TEST..'AnothaNsba:TEST'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
TEST(msg.chat_id_, msg.id_, 1, '↯☆تم الغاء امر نسبة الانوثه ', 1, 'md')
TEST:del(TEST..'AnothaNsba:TEST'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
TEST = math.random(0,100);
TEST(msg.chat_id_, msg.id_, 1, '↯☆نسبة انوثة '..text..' هي : '..TEST..'%', 1, 'md')
TEST:del(TEST..'AnothaNsba:TEST'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
--     Source TEST     --
...
local TESTTEAM = '↯☆اهلا عزيزي ⇇ '..TESTRank(msg)..' \n↯☆تم تفعيل حساب العمر'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TESTTEAM, 14, string.len(msg.sender_user_id_))
TEST:del(TEST..'TEST:Age:TEST'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and SourceCh(msg) then
local TESTTEAM =
'↯☆اهلا عزيزي ⇇ '..TESTRank(msg)..' \n↯☆تم تعطيل حساب العمر'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TESTTEAM, 14, string.len(msg.sender_user_id_))
TEST:set(TEST..'TEST:Age:TEST'..msg.chat_id_,true)  
end
--     Source TEST     --
if not TEST:get(TEST..'TEST:Age:TEST'..msg.chat_id_) then
if text and text:match("^احسب (.*)$") and SourceCh(msg) or text and text:match("^عمري (.*)$") and SourceCh(msg) then 
local TextAge = text:match("^احسب (.*)$") or text:match("^عمري (.*)$") 
UrlAge = https.request('https://apiabs.ml/age.php?age='..URL.escape(TextAge)) 
Age = JSON.decode(UrlAge) 
t = Age.ok.abs
TEST(msg.chat_id_, msg.id_, 1, t, 1, 'html')
end
end
--     Source TEST     --
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TESTTEAM, 14, string.len(msg.sender_user_id_))
TEST:del(TEST..'TEST:Mean:TEST'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and SourceCh(msg) then
local TESTTEAM = '↯☆اهلا عزيزي ⇇ '..TESTRank(msg)..' \n↯☆تم تعطيل معاني الاسماء'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TESTTEAM, 14, string.len(msg.sender_user_id_))
TEST:set(TEST..'TEST:Mean:TEST'..msg.chat_id_,true)  
end
--     Source TEST     --
if not TEST:get(TEST..'TEST:Mean:TEST'..msg.chat_id_) then
if text and text:match("^معنى الاسم (.*)$") and SourceCh(msg) or text and text:match("^معنى اسم (.*)$") and SourceCh(msg) then 
local TextMean = text:match("^معنى الاسم (.*)$") or text:match("^معنى اسم (.*)$") 
UrlMean = https.request('https://apiabs.ml/Mean.php?TEST='..URL.escape(TextMean)) 
